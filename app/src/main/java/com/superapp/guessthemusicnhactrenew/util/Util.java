...
public class Util {
    ...
    public static File getPhotoFile(File rootPath, String name, String folderName) throws IOException {
    ...
    public static File getFile(File rootPath, String name, String folderName) throws IOException {
        String state = Environment.getExternalStorageState();
